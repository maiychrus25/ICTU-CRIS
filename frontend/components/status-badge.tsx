...
const states = {
  ...
  Nhap: { icon: FileText, className: "border-primary/25 bg-primary/10 text-primary" },
  ChoBoSung: { icon: Clock3, className: "border-status-warning/30 bg-status-warning/10 text-status-warning" },
  Rut: { icon: Ban, className: "border-status-danger/25 bg-status-danger/10 text-status-danger" },
