...
import { useDecideDuplicate, useDuplicateGroup, useOfficerAccess } from "@/lib/queries";
...
function DuplicateDetailContent() {
  ...
  async function submitDecision(input: DecideDupIn) {
    try {
      ...
      if (!(error instanceof ApiError && error.handled)) toast.error(error instanceof ApiError ? error.detail : "Không thể lưu quyết định.");
    }
  }
