...
function Metric({ label, value }: { label: string; value: React.ReactNode }) {
  return <><dt className="pt-3 text-xs text-muted-foreground">{label}</dt><dd className="border-b pb-3 font-medium tabular-nums last:border-0">{value}</dd></>;
}
