...
- Không có dòng ghi công AI (`Co-Authored-By`…) trong thông điệp commit — hook `commit-msg` (pre-commit) và job CI `commit-messages` chặn (`scripts/check_commit_trailers.py`); xem `AGENTS.md`.
