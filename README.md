...
- [x] **0.6.1 đã phát hành (13/09)** — logo sản phẩm, SEO (metadata, JSON-LD, robots, sitemap), tài liệu hướng dẫn sử dụng đầy đủ
