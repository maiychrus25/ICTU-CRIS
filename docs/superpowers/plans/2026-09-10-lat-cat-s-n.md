...
**Files:**
- Create: `cris/quality.py`, `cris/cli.py`, `cris/__main__.py`, `cris/migrations/0003_views.sql`, `tests/test_quality.py`
...
`cris/migrations/0003_views.sql`:
...
Expected: `['0003_views.sql']` rồi tất cả test PASS (Task 1 đến 9).

- [ ] **Step 5: Commit**

```bash
git add cris/quality.py cris/cli.py cris/__main__.py cris/migrations/0003_views.sql cris/sync.py cris/source/repository.py cris/people.py tests/test_quality.py
