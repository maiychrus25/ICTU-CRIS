...
| 5 | Ma trận phân quyền | [05-permissions.md](05-permissions.md) | 6 actor người + 1 hệ thống nguồn |
...
| 11 | Đặc tả use case | [11-usecase-spec.md](11-usecase-spec.md) | UC-01..16 |
| 12 | Use scenario | [12-scenarios.md](12-scenarios.md) | 5 kịch bản |
| 13 | User story + AC | [13-user-stories.md](13-user-stories.md) | US-01..34 |
